  ...
  return (
    <div className="relative">
      <input
        ...
        value={value}
        onChange={onChange}
        className="w-full px-3 py-2 pr-10 rounded-lg border border-gray-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-colors text-sm"
...
const AuthPages: React.FC<AuthPagesProps> = ({ mode = "login" }) => {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      if (err.code === "auth/unauthorized-domain") {
        setError(
          "Google登录在此域名上不可用。请在Firebase控制台添加此域名(18.219.5.101)到授权域名列表中，或使用邮箱密码登录。"
        );
      } else {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setError(
        err.message || `${mode === "login" ? "Login" : "Signup"} failed`
      );
    }
  };
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-4">
            ...
            <p className="text-sm text-gray-600">
              {mode === "login"
                ? "Sign in to continue your data analytics journey"
                : "Start your professional data analytics journey"}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded-lg border border-gray-200 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-colors text-sm"
          ...
          {/* Social Login Section - Moved outside the form */}
            ...
            <div className="space-y-2">
              <h2 className="text-4xl font-neuton font-light text-gray-900">
                {mode === "login"
                  ...
                  : "Join DataInsight Pro"}
              </h2>
              <p className="text-xl text-gray-600 font-neuton">
                {mode === "login"
                  ? "Let data analytics power your business growth"
                  : "Unlock the power of data for professional insights"}
              </p>
            </div>
          </div>
        </div>
