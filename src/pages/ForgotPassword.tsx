          ...
          <div className="h-full flex items-center justify-center p-8">
            <div className="max-w-lg">
              ...
              <p className="text-base text-gray-600 font-neuton">
                We'll help you regain access to your data analytics dashboard.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-6">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-2 px-4 rounded-lg font-medium transition-colors text-sm bg-blue-600 text-white hover:bg-blue-700"
            >
          ...
          <Link
            to="/login"
            className="mt-4 inline-flex items-center space-x-1 text-blue-600 hover:text-blue-700 text-sm"
          >
            <ArrowLeft className="w-4 h-4" />
            <span>Back to login</span>
          </Link>
